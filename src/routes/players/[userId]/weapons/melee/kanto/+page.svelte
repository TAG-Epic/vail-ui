<script lang="ts">
    ...
    export let data;
    let skinProgression = WEAPON_ID_TO_PROGRESSION.kanto;
...
<div>
    ...
    <h2>Throws</h2>
    <p>Kills while throwing: {data.meleeStats.total.kills.throwing.total}</p>
    <p>Longest throwing kill: {data.meleeStats.total.kills.throwing.longest_throw/100}m</p>
</div>
<style>
    h1,h2,p {
        color: #fff;
